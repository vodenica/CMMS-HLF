...
class CreatePreventiveWorkOrderWorkload extends WorkloadModuleBase {
  /**
  ...
  async submitTransaction() {
    ...
    let prevmtewo = "docType-prevmtewo" + this.worker + this.txIndex.toString();

    const prev_work_order_id =
...
function createWorkloadModule() {
  return new CreatePreventiveWorkOrderWorkload();
}
