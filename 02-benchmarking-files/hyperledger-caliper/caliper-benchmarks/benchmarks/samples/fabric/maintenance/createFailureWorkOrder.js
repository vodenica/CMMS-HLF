...
class CreateFailureWorkOrderWorkload extends WorkloadModuleBase {
  /**
  ...
  async submitTransaction() {
    ...
    let corrmtewo = "docType-failmtewo" + this.worker + this.txIndex.toString();

    const fail_work_order_id =
      "failure-work-order-ID-" +
    ...
    const failureMaintenanceProcessSteps = {
    ...
    const request = {
      ...
      contractArguments: [
        ...
        JSON.stringify(failureMaintenanceProcessSteps),
...
function createWorkloadModule() {
  return new CreateFailureWorkOrderWorkload();
}
