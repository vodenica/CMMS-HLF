...
* Three separate tables depict the test results for three distinct regions [Table 2](#table-2---multi-region-summary-for-SE-region), [Table 3](#table-3), and [Table 4](#table-4).
